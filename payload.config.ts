        ...
        const SEED_TEAM = [
          {
            ...
            bookingUrls: [
              { subject: 'maths', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'speed-maths', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'vce', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'selective', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'scholarship', url: 'https://cal.com/theonlinekids-anz-7xggme' },
            ],
            order: 1,
          },
          {
            ...
            bookingUrls: [
              { subject: 'english', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'science', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'maths', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'selective', url: 'https://cal.com/theonlinekids-anz-7xggme' },
              { subject: 'scholarship', url: 'https://cal.com/theonlinekids-anz-7xggme' },
            ],
          ...
          },
          {
            ...
            subjects: ['coding'],
            bookingUrls: [
              { subject: 'coding', url: 'https://cal.com/theonlinekids-anz-7xggme' },
            ],
            order: 5,
          },
        ]
